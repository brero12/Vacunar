...
<ul class="sidebar-menu">
	...
	<li class="treeview active">
		...
		<ul class="treeview-menu">
			...
			<li><a href="JavaScript:viewSchema(null);"><i class="fa" style="content:url(img/menu/checklist_item_menu.png); height:14px; width:14px"></i> Esquema vacunaci&oacute;n</a></li>
		</ul>
	</li>
