...
if (defined('PHALANGER')){
	...
	if ($aZ_ionCube){
		...
		if (file_exists('axZm.class.ioncube.7.php') && file_exists('axZm.class.ioncube.8.php'))
		{
			// PHP 5.2
	...
	/*
	elseif ($aZ_zendOptimizer){
		echo 'Zend Optimizer support for AJAX-ZOOM will be added shortly. Pleas use "Ioncube" loaders for now.';
	} elseif ($aZ_zendGuard){
		echo 'Zend Guard support for AJAX-ZOOM will be added shortly. Pleas use "Ioncube" loaders for now.';
	}
	
	else {
		echo "It seems that neither Ioncube loaders, nor SourceGuardian loaders are installed; these loaders are free. Please install one of the loaders or let your server administrator install it for you. Ioncube loader is recommended.";
		exit;
	}
	*/
}
