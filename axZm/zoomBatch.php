...
set $zoom['config']['pic'] below as "base directory" of your images around line 138 !!!

*****************************************************************************************************************************
DEPENDING ON EXAMPLE OR IMPLEMENTATION YOU CAN SET 
$_GET['example'] = the "example=" which is passed in your implementation (uncomment and set around line 44)
IF YOU DO NOT KNOW WHICH "example=" it is, please use Firebug to analize ajax-calls in console !!!
*****************************************************************************************************************************
...
// SET THIS VAR to example / implementation you are using
// $_GET['example'] = 'magento';


// Simple (very basic) password protection for this file
// Please modify or remove it
$yourSecretPassWord = mt_rand().mt_rand(); // change this password 
	...
	<script type=\"text/javascript\">
		...
		$.zoomBatch.checkSelected = function(){
			...
			$('#passFiles input[type=checkbox]').each(function(){
				...
				if ($(this).axZmGetPropType('checked')){
					n++; return false;
				}
			});
