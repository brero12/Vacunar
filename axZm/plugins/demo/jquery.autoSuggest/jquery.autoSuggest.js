                ...
                function processData(data, query){
					...
					for(var i=0;i<d_count;i++){
                        ...
                        if(str){
							...
							// Added by AJAX-ZOOM
							if (opts.matchFirstLetters){
								var firstChars = str.substring(0, numChars);
								if (firstChars == query && values_input.val().search(","+data[num][opts.selectedValuesProp]+",") == -1){
									forward = true;
								}
							}else{
