 ...
 */
        ...
        $id_mom =  updateMomChild($fk_tbl_tipo_identificacionMadre, $numero_identificacionMadre, $primer_nombreMadre, 
        ...
        echo $numero_identificacion.' - '.$primer_nombre.' - '.$segundo_nombre.' - '.$primer_apellido.'<br>';
        
        $idChild = updateChild($fk_tbl_tipo_identificacion, $numero_identificacion, $primer_nombre, 
